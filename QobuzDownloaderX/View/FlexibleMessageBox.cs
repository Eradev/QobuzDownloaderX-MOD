    ...
    public class FlexibleMessageBox
    {
        ...
        class FlexibleMessageBoxForm : Form
        {
            ...
            private void ApplyCustomTheme()
            {
                ...
                richTextBoxMessage.BackColor = Color.FromArgb(30, 30, 30);
            ...
            private static double GetCorrectedWorkingAreaFactor(double workingAreaFactor)
            {
                ...
                return workingAreaFactor > MAX_FACTOR
                    ? MAX_FACTOR
                    : workingAreaFactor;
            }
            ...
            /// <summary>
            /// Calculate the dialogs start size (Try to auto-size width to show the longest text row).
            ...
            public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton)
            {
                ...
                //Calculate the dialogs start size (Try to auto-size width to show the longest text row). Also set the maximum dialog size.
